...
function CardTable(props) {
    ...
    let tableBody = (data) => {
        ...
        data.forEach((record) => {
            ...
            if (record.month in tableData) {
                if (record.category in tableData[record.month]) {
                    tableData[record.month][record.category] = tableData[record.month][record.category] + record.price
                }
                else {
                    tableData[record.month][record.category] = record.price
                }
            }
            else {
                tableData[record.month] = {[record['category']]: record.price}
